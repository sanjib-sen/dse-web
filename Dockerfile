...
RUN apk add --no-cache musl-dev upx pkgconfig openssl-dev make perl binaryen
WORKDIR /app
COPY . .
...
# RUN wasm-opt /app/dist/assets/dioxus/SENX_DSE_bg.wasm -o /app/dist/assets/dioxus/SENX_DSE_bg.wasm -Oz
